...
import { GraduationCap, Briefcase, Plane, Eye, X, Sparkles, MessageCircle } from "lucide-react";
...
export function AboutSection() {
  ...
  return (
    <section id="about" className="bg-white text-slate-800 pt-6 pb-8 sm:pt-8 sm:pb-12 relative overflow-hidden border-b border-slate-100">
      ...
      {/* Budget Friendly Countries (Both Cards in One Row, Click to View) */}
      <div className="mx-auto max-w-7xl px-4 sm:px-6 mt-10 sm:mt-14 pt-8 sm:pt-10 border-t border-slate-200/80">
