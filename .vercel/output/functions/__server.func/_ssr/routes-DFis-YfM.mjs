...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DFis-YfM.js
...
function SiteHeader() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: "fixed inset-x-0 top-0 z-50 border-b border-primary-foreground/10 bg-ink/40 backdrop-blur-xl",
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						className: "font-display text-lg tracking-[0.18em] text-primary-foreground uppercase",
...
var title = "Mani Abroad Consultancy";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				style: { background: "linear-gradient(to top, var(--ink), transparent 55%)" }
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative mx-auto w-full max-w-7xl px-6 pt-28",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "mt-6 max-w-4xl font-display text-5xl leading-[1.05] text-sky-400 sm:text-7xl lg:text-8xl",
						children: title.split(" ").map((word, wi) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "mr-[0.28em] inline-block whitespace-nowrap",
							children: word.split("").map((ch, ci) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `${videoPlaying ? "animate-letter-in" : "opacity-0"} inline-block`,
								style: { animationDelay: `${.8 + wi * .22 + ci * .045}s` },
								children: ch
							}, ci))
						}, wi))
					}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "hello@maniabroad.com \xA0·\xA0 +91 98000 00000" })]
			})]
		})
	});
}
function Index() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeroSection, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AboutSection, {})] }),
